...
const SOFTWARE_LIST = [
  {
    ...
    soal: [
      {
        q: "Android dikembangkan oleh perusahaan...",
        opts: ["Apple", "Microsoft", "Google", "Samsung"],
        ans: 2,
      },
      {
        q: "Android berbasis kernel...",
        opts: ["Windows NT", "Darwin", "Linux", "BSD"],
        ans: 2,
      },
      {
        q: "Android pertama kali dirilis pada tahun...",
    ...
    soal: [
      {
        ...
        opts: ["Mozilla", "Microsoft", "Apple", "Google"],
        ans: 3,
      },
      {
        q: "Google Chrome menggunakan rendering engine...",
        opts: ["Gecko", "WebKit", "Blink", "Trident"],
        ans: 2,
      },
      {
        q: "Google Chrome termasuk jenis software...",
        opts: ["Sistem operasi", "Web browser", "Pengolah kata", "Antivirus"],
        ans: 1,
      },
      {
        q: "Fitur penjelajahan pribadi di Chrome disebut...",
        opts: ["Private Mode", "Incognito", "InPrivate", "Ghost Mode"],
        ans: 1,
      },
      {
  ...
  },
  {
    ...
    soal: [
      {
        q: "CorelDRAW dikembangkan oleh...",
        opts: ["Adobe", "Corel Corporation", "Autodesk", "Microsoft"],
        ans: 1,
      },
      {
        q: "CorelDRAW adalah software berbasis grafis...",
        opts: ["Raster/bitmap", "3D", "Vektor", "Audio"],
        ans: 2,
      },
      {
        q: "Format file utama CorelDRAW adalah...",
        opts: [".PSD", ".AI", ".CDR", ".SVG"],
        ans: 2,
      },
      {
        q: "CorelDRAW termasuk jenis software...",
        opts: ["Sistem operasi", "Pengolah kata", "Desain grafis", "Browser"],
        ans: 2,
      },
      {
        q: "CorelDRAW paling sering digunakan untuk...",
        opts: [
          "Mengedit video",
  ...
  },
  {
    ...
    soal: [
      {
        q: "Microsoft Excel dikembangkan oleh...",
        opts: ["Google", "Apple", "Microsoft", "IBM"],
        ans: 2,
      },
      {
        q: "Microsoft Excel termasuk jenis software...",
        opts: [
          "Sistem operasi",
      ...
      {
        q: "Format file modern Microsoft Excel adalah...",
        opts: [".DOC", ".PPT", ".XLSX", ".PDF"],
        ans: 2,
      },
      {
        q: "Fungsi untuk menjumlahkan data di Excel adalah...",
        opts: ["=TOTAL()", "=ADD()", "=SUM()", "=COUNT()"],
        ans: 2,
      },
      {
        q: "Microsoft Excel adalah bagian dari paket...",
        opts: [
  ...
  },
  {
    ...
    soal: [
      {
        q: "Linux pertama kali dibuat oleh...",
      ...
      {
        q: "Linux termasuk jenis software...",
        opts: ["Browser", "Pengolah kata", "Sistem operasi", "Antivirus"],
        ans: 2,
      },
      {
        q: "Android menggunakan kernel dari...",
        opts: ["Windows", "macOS", "Linux", "BSD"],
        ans: 2,
      },
    ],
  },
    ...
    soal: [
      {
        ...
        opts: ["Corel", "Microsoft", "Adobe", "Autodesk"],
        ans: 2,
      },
      {
        q: "Adobe Photoshop adalah software berbasis grafis...",
        opts: ["Vektor", "Raster/bitmap", "3D", "Audio"],
        ans: 1,
      },
      {
      ...
      {
        q: "Adobe Photoshop termasuk jenis software...",
        opts: [
          "Sistem operasi",
      ...
      {
        q: "Perbedaan Photoshop dengan CorelDRAW adalah...",
        opts: [
          "Photoshop berbasis vektor, CorelDRAW raster",
  ...
  },
  {
    ...
    soal: [
      {
        q: "Microsoft PowerPoint dikembangkan oleh...",
        opts: ["Google", "Apple", "Microsoft", "Corel"],
        ans: 2,
      },
      {
        q: "PowerPoint termasuk jenis software...",
        opts: ["Sistem operasi", "Pengolah kata", "Presentasi", "Browser"],
        ans: 2,
      },
      {
        q: "Format file modern Microsoft PowerPoint adalah...",
        opts: [".DOCX", ".XLSX", ".PPTX", ".PDF"],
        ans: 2,
      },
      {
        q: "Unit dasar pembuat konten di PowerPoint disebut...",
        opts: ["Halaman", "Lembar kerja", "Slide", "Kanvas"],
        ans: 2,
      },
      {
        q: "PowerPoint adalah bagian dari paket...",
        opts: [
          "Adobe Creative Suite",
          "Google Workspace",
          "Microsoft Office",
  ...
  },
  {
    ...
    soal: [
      ...
      {
        q: "Versi Windows terbaru yang dirilis adalah...",
        opts: ["Windows 8", "Windows 10", "Windows 11", "Windows 12"],
        ans: 2,
      },
      {
        q: "Tombol logo Windows pada keyboard berfungsi untuk...",
        opts: [
          "Membuka browser",
          "Membuka Start Menu",
          "Mematikan komputer",
  ...
  },
  {
    ...
    soal: [
      {
        q: "Microsoft Word dikembangkan oleh...",
        opts: ["Google", "Apple", "Microsoft", "Corel"],
        ans: 2,
      },
      {
        q: "Microsoft Word termasuk jenis software...",
        opts: ["Sistem operasi", "Pengolah kata", "Spreadsheet", "Browser"],
        ans: 1,
      },
      {
        q: "Format file modern Microsoft Word adalah...",
        opts: [".XLSX", ".PPTX", ".DOCX", ".PDF"],
        ans: 2,
      },
      {
        q: "Shortcut keyboard untuk mencetak dokumen di Word adalah...",
        opts: ["Ctrl+S", "Ctrl+P", "Ctrl+C", "Ctrl+V"],
        ans: 1,
      },
      {
        q: "Microsoft Word adalah bagian dari paket...",
        opts: [
          "Adobe Creative Suite",
          "Microsoft Office",
          "Google Workspace",
...
const STORAGE_HISTORY = "game_history_level2";
const STORAGE_LEVEL2_DONE = "game_level2_ever_done";
const LEVEL = 2;
...
function useResponsiveSizes() {
  function calc() {
    ...
    if (isMobile) {
      const availW = vw - 32;
      const availH = vh - 160;
      const maxByW = Math.floor(availW / 2) - GAP * 2;
      const maxByH = Math.floor(availH * 0.5) - 40;
      PIECE = Math.max(70, Math.min(130, maxByW, maxByH));
      TRAY_PIECE = Math.round(PIECE * 0.75);
    } else if (isTablet) {
      const availW = vw - 48;
      const availH = vh - 120;
      const maxByW = Math.floor((availW - 32) / 2) - GAP * 2;
      const maxByH = Math.floor(availH) - 80;
      PIECE = Math.max(90, Math.min(170, maxByW, maxByH));
      TRAY_PIECE = Math.round(PIECE * 0.78);
    } else {
      const centerW = vw - panelW * 2 - 48;
      const centerH = vh - 60 - 48;
      const maxByW = Math.floor((centerW - 40) / 2) - GAP * 2;
      const maxByH = Math.floor(centerH) - 80;
      PIECE = Math.max(100, Math.min(200, maxByW, maxByH));
...
// ── PuzzlePiece ───────────────────────────────────────────────────────────────
function PuzzlePiece({ imgSrc, pieceIdx, size, grid = 2 }) {
  ...
  return (
    <div className="side-panel">
      ...
      <div className="info-tip">
        ...
        <p>Susun puzzle dengan benar untuk membuka pertanyaan tentang software ini!</p>
      </div>
    </div>
  );
}
...
export default function Level2() {
  ...
  const [tray, setTray] = useState(() => shuffle([0, 1, 2, 3]));
  ...
  const saveScore = useCallback((score, currentAttempt) => {
    ...
    const alreadyDone = getUserItem(STORAGE_LEVEL2_DONE, false);
    if (!alreadyDone) {
      setUserItem(STORAGE_LEVEL2_DONE, true);
    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width:599px) { .lv-main { gap:14px; flex-direction:column; align-items:center; } }
      ...
      <div className="lv">
        ...
        <header className="lv-hdr">
          ...
          <div className="lv-hdr-right">
            ...
            <div className="lv-badge">LVL 2</div>
          </div>
        </header>
              ...
              <div className="lv-main">
                ...
                <div className="lv-tray-wrap">
                  ...
                  <div
                    ...
                    style={{
                      gridTemplateColumns: `repeat(2, ${TRAY_PIECE + 16}px)`,
                      gridTemplateRows: `repeat(2, ${TRAY_PIECE + 16}px)`,
                    }}
                    ...
                    {[0, 1, 2, 3].map((slotIdx) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ width: TRAY_PIECE + 16, height: TRAY_PIECE + 16 }}
                        >
                          {pi !== undefined ? (
        ...
        {showPreview && (
          <div className="lv-overlay" onClick={() => setShowPreview(false)}>
            <div className="lv-modal" style={{ maxWidth: 500 }} onClick={(e) => e.stopPropagation()}>
              ...
              <img src={sw.img} alt={sw.nama} style={{ width: "100%", maxHeight: 360, objectFit: "contain", border: "1px solid rgba(180,0,255,.3)", marginBottom: 20, borderRadius: 4 }} />
            ...
            <div className="lv-modal">
              ...
              <div style={{ marginBottom: 12, padding: "10px 16px", background: "rgba(120,0,255,.08)", border: "1px solid rgba(180,0,255,.25)" }}>
                <p style={{ fontSize: 12, color: "rgba(220,180,255,.85)", fontFamily: "Rajdhani", lineHeight: 1.6 }}>
                  ...
                  <strong style={{ color: "#e879f9", letterSpacing: 1 }}>LEVEL 2 — {sw.nama.toUpperCase()}</strong>
                </p>
              </div>
              {isFirstEverDone && (
                <div style={{ marginBottom: 12, padding: "8px 16px", background: "rgba(52,211,153,.06)", border: "1px solid rgba(52,211,153,.25)", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                  ...
                  <p style={{ fontSize: 11, color: "#34D399", letterSpacing: 2, fontFamily: "Rajdhani", fontWeight: 700 }}>LEVEL 3 TERBUKA!</p>
                </div>
              )}
              {prevScore !== null && (
                <div style={{ marginBottom: 10, padding: "4px 14px", background: "rgba(180,0,255,.06)", border: "1px solid rgba(180,0,255,.2)" }}>
                  <p style={{ fontSize: 10, color: "rgba(180,0,255,.55)", letterSpacing: 2, fontFamily: "Rajdhani" }}>SKOR SEBELUMNYA: {prevScore}</p>
                </div>
              )}
              {isNewRec && (
                <div style={{ marginBottom: 14, padding: "6px 16px", background: "rgba(251,191,36,.08)", border: "1px solid rgba(251,191,36,.28)" }}>
                  <p style={{ fontSize: 10, color: "#FBBF24", letterSpacing: 2, fontFamily: "Rajdhani" }}>🏆 REKOR BARU! Skor tersimpan ke profil.</p>
                </div>
              )}
              <div className="lv-macts" style={{ marginTop: 8 }}>
                <button className="lv-btn lv-btn-s" onClick={() => navigate("/game")}>KEMBALI</button>
                <button className="lv-btn lv-btn-s" onClick={initPuzzle}>MULAI ULANG</button>
                <button className="lv-btn lv-btn-g" onClick={() => navigate("/game/level/3")}>LANJUT →</button>
              </div>
            </div>
          </div>
        )}

...
const HARDWARE_LIST = [
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "CPU (Central Processing Unit) adalah otak dari komputer yang bertugas memproses semua instruksi dan data dari program yang sedang berjalan.",
    fakta: [
      "Disebut sebagai otak komputer",
      "Mengeksekusi instruksi program secara berurutan",
      "Kecepatannya diukur dalam GHz (Gigahertz)",
    ],
    soal: [
      {
        q: "CPU adalah singkatan dari...",
        opts: ["Central Power Unit", "Central Processing Unit", "Computer Processing Unit", "Central Program Unit"],
        ans: 1,
      },
      {
        q: "CPU sering disebut sebagai... komputer",
      ...
      {
        q: "Tugas utama CPU adalah...",
        opts: [
          "Menyimpan data secara permanen",
          "Menampilkan gambar ke monitor",
          "Memproses instruksi dan data program",
          "Menghubungkan komputer ke internet",
        ],
        ans: 2,
      },
      {
        q: "CPU termasuk komponen hardware jenis...",
        opts: ["Perangkat output", "Perangkat input", "Perangkat proses", "Perangkat penyimpanan"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Headset adalah perangkat gabungan headphone dan mikrofon yang digunakan untuk mendengarkan suara sekaligus berbicara, sering dipakai saat gaming atau meeting online.",
    fakta: [
      "Gabungan headphone (output) dan mikrofon (input)",
      "Tersedia jenis wired dan wireless (Bluetooth)",
      "Banyak digunakan untuk gaming dan komunikasi online",
    ],
    soal: [
      {
        q: "Headset merupakan gabungan dari...",
        opts: ["Speaker dan monitor", "Headphone dan mikrofon", "Mouse dan keyboard", "Printer dan scanner"],
        ans: 1,
      },
      {
        q: "Headset termasuk perangkat...",
        opts: ["Hanya input", "Hanya output", "Input sekaligus output", "Perangkat proses"],
        ans: 2,
      },
      {
        q: "Bagian headset yang berfungsi sebagai OUTPUT adalah...",
        opts: ["Mikrofon", "Kabel USB", "Headphone/speaker telinga", "Tombol mute"],
        ans: 2,
      },
      {
        q: "Headset wireless umumnya menggunakan teknologi...",
        opts: ["Infrared", "Bluetooth", "WiFi Direct", "NFC"],
        ans: 1,
      },
      {
        q: "Fungsi tombol mute pada headset adalah...",
        opts: [
          "Mematikan headphone",
          "Menonaktifkan mikrofon sementara",
          "Menambah volume",
          "Mematikan komputer",
        ],
        ans: 1,
  ...
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Keyboard adalah perangkat input utama komputer yang digunakan untuk mengetik teks, angka, dan simbol, serta menjalankan perintah melalui tombol-tombolnya.",
    fakta: [
      "Perangkat input utama komputer",
      "Susunan huruf standar: QWERTY",
      "Tersedia dalam berbagai jenis: mekanik, membran, wireless",
    ],
    soal: [
      {
        q: "Keyboard termasuk perangkat...",
        opts: ["Output", "Penyimpanan", "Input", "Proses"],
        ans: 2,
      },
      {
        q: "Susunan huruf standar yang digunakan pada keyboard adalah...",
        opts: ["AZERTY", "QWERTY", "DVORAK", "COLEMAK"],
        ans: 1,
      },
      {
        q: "Tombol yang digunakan untuk menghapus karakter di sebelah kiri kursor adalah...",
        opts: ["Delete", "Backspace", "Escape", "Enter"],
        ans: 1,
      },
      {
        q: "Keyboard jenis mekanik berbeda dari membran karena...",
        opts: [
          "Tidak memiliki tombol",
          "Menggunakan switch mekanis di setiap tombol",
          "Hanya bisa digunakan secara nirkabel",
          "Tidak bisa mengetik angka",
        ],
        ans: 1,
      },
      {
        q: "Fungsi tombol Ctrl+C pada keyboard adalah...",
        opts: ["Memotong teks", "Menempel teks", "Menyalin teks", "Menghapus teks"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Monitor adalah perangkat output utama komputer yang menampilkan gambar, teks, dan video dari komputer kepada pengguna dalam bentuk visual.",
    fakta: [
      "Perangkat output utama komputer",
      "Resolusi diukur dalam piksel (contoh: 1920×1080)",
      "Tersedia teknologi LCD, LED, OLED, dan IPS",
    ],
    soal: [
      {
        q: "Monitor termasuk perangkat...",
        opts: ["Input", "Proses", "Output", "Penyimpanan"],
        ans: 2,
      },
      {
        q: "Resolusi monitor diukur dalam satuan...",
        opts: ["GHz", "Piksel", "Watt", "DPI"],
        ans: 1,
      },
      {
        q: "Resolusi monitor Full HD adalah...",
        opts: ["1280×720", "1920×1080", "2560×1440", "3840×2160"],
        ans: 1,
      },
      {
        q: "Teknologi layar monitor yang paling hemat daya adalah...",
        opts: ["CRT", "Plasma", "LCD/LED", "Proyektor"],
        ans: 2,
      },
      {
        q: "Refresh rate monitor yang lebih tinggi berarti...",
        opts: [
          "Gambar lebih gelap",
          "Tampilan lebih halus dan responsif",
  ...
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Mouse adalah perangkat input yang digunakan untuk menggerakkan kursor di layar, memilih objek, dan menjalankan perintah melalui klik dan gerakan.",
    fakta: [
      "Perangkat penunjuk (pointing device)",
      "Ditemukan oleh Douglas Engelbart (1964)",
      "Tersedia jenis optik, laser, dan trackball",
    ],
    soal: [
      {
        q: "Mouse termasuk perangkat...",
        opts: ["Output", "Input", "Proses", "Penyimpanan"],
        ans: 1,
      },
      {
        q: "Mouse pertama kali ditemukan oleh...",
        opts: ["Bill Gates", "Steve Jobs", "Douglas Engelbart", "Linus Torvalds"],
        ans: 2,
      },
      {
        q: "Sensitivitas mouse diukur dalam satuan...",
        opts: ["GHz", "DPI", "MB", "Hz"],
        ans: 1,
      },
      {
        q: "Scroll wheel pada mouse digunakan untuk...",
        opts: [
          "Mengklik objek",
          "Menggerakkan kursor horizontal",
          "Menggulir halaman atas/bawah",
          "Memperbesar tampilan",
        ],
        ans: 2,
      },
      {
        q: "Mouse optik bekerja menggunakan...",
        opts: ["Bola karet", "Sinar laser/LED dan sensor", "Magnet", "Layar sentuh"],
        ans: 1,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Printer adalah perangkat output yang mencetak dokumen digital dari komputer ke media fisik seperti kertas, menghasilkan salinan cetak dari teks dan gambar.",
    fakta: [
      "Perangkat output untuk mencetak dokumen",
      "Jenis utama: inkjet dan laser",
      "Kualitas cetak diukur dalam DPI (dots per inch)",
    ],
    soal: [
      {
        q: "Printer termasuk perangkat...",
        opts: ["Input", "Proses", "Penyimpanan", "Output"],
        ans: 3,
      },
      {
        q: "Kualitas cetak printer diukur dalam satuan...",
        opts: ["GHz", "MB", "DPI", "Hz"],
        ans: 2,
      },
      {
        q: "Printer inkjet bekerja dengan cara...",
        opts: [
          "Menyemprotkan tinta cair ke kertas",
          "Menggunakan bubuk toner dan panas",
          "Menggunakan laser dan drum",
          "Mencetak menggunakan jarum",
        ],
        ans: 0,
      },
      {
        q: "Printer laser menggunakan... untuk mencetak",
        opts: ["Tinta cair", "Bubuk toner dan drum", "Jarum dot matrix", "Pita tinta"],
        ans: 1,
      },
      {
        q: "Printer yang bisa mencetak, memindai, dan menyalin disebut...",
        opts: ["Printer laser", "Printer inkjet", "Printer multifungsi (AIO)", "Printer dot matrix"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Modem (Modulator-Demodulator) adalah perangkat jaringan yang mengubah sinyal digital dari komputer menjadi sinyal analog untuk dikirim melalui saluran telepon atau kabel, dan sebaliknya.",
    fakta: [
      "Singkatan dari Modulator-Demodulator",
      "Menghubungkan komputer ke jaringan internet",
      "Tersedia jenis DSL, kabel, fiber, dan mobile (4G/5G)",
    ],
    soal: [
      {
        q: "Modem adalah singkatan dari...",
        opts: ["Modern Device", "Modulator-Demodulator", "Module Demon", "Monitor Decoder"],
        ans: 1,
      },
      {
      ...
      {
        q: "Modem termasuk perangkat...",
        opts: ["Input", "Output", "Jaringan", "Proses"],
        ans: 2,
      },
      {
        q: "Modem yang menggunakan sinyal seluler 4G/5G disebut...",
        opts: ["Modem DSL", "Modem kabel", "Modem fiber", "Modem mobile"],
        ans: 3,
      },
      {
        q: "Proses mengubah sinyal digital menjadi sinyal analog disebut...",
        opts: ["Demodulasi", "Modulasi", "Enkripsi", "Kompresi"],
        ans: 1,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Microphone (mikrofon) adalah perangkat input audio yang mengubah gelombang suara dari lingkungan menjadi sinyal listrik yang dapat diproses oleh komputer.",
    fakta: [
      "Perangkat input audio komputer",
      "Mengubah gelombang suara menjadi sinyal listrik",
      "Tersedia jenis condenser, dynamic, dan USB",
    ],
    soal: [
      {
        q: "Microphone termasuk perangkat...",
        opts: ["Output", "Proses", "Input", "Penyimpanan"],
        ans: 2,
      },
      {
        q: "Fungsi utama microphone adalah...",
        opts: [
      ...
      {
        q: "Perangkat yang merupakan kebalikan fungsi dari microphone adalah...",
        opts: ["Monitor", "Keyboard", "Speaker", "Printer"],
        ans: 2,
      },
      {
        q: "Microphone jenis condenser dikenal karena...",
        opts: [
          "Harganya paling murah",
          "Sensitivitas tinggi dan kualitas suara detail",
          "Tidak membutuhkan daya listrik",
          "Hanya bisa digunakan untuk telepon",
        ],
        ans: 1,
      },
      {
        q: "Microphone USB berbeda dari microphone XLR karena...",
        opts: [
          "Kualitas suaranya lebih buruk",
          "Tidak bisa merekam suara",
          "Langsung terhubung ke komputer tanpa audio interface",
          "Hanya berfungsi di perangkat mobile",
        ],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Speaker adalah perangkat output audio yang mengubah sinyal listrik dari komputer menjadi suara yang dapat didengar oleh pengguna.",
    fakta: [
      "Perangkat output audio komputer",
      "Kualitas suara diukur dalam Hz (frekuensi) dan Watt (daya)",
      "Terdiri dari woofer (bass) dan tweeter (treble)",
    ],
    soal: [
      {
        q: "Speaker termasuk perangkat...",
        opts: ["Input", "Proses", "Output", "Penyimpanan"],
        ans: 2,
      },
      {
        q: "Fungsi utama speaker pada komputer adalah...",
        opts: [
          "Merekam suara dari lingkungan",
          "Mengubah sinyal listrik menjadi suara",
          "Menyimpan file audio",
          "Mengirim suara melalui jaringan",
        ],
        ans: 1,
      },
      {
        q: "Daya output speaker diukur dalam satuan...",
        opts: ["GHz", "DPI", "Watt", "MB"],
        ans: 2,
      },
      {
        q: "Komponen speaker yang menghasilkan suara frekuensi rendah (bass) disebut...",
        opts: ["Tweeter", "Woofer", "Amplifier", "Subwoofer kecil"],
        ans: 1,
      },
      {
        q: "Perangkat input audio yang berfungsi kebalikan dari speaker adalah...",
        opts: ["Headphone", "Earphone", "Mikrofon", "Sound card"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Hardware",
    deskripsi:
      "Proyektor adalah perangkat output yang memproyeksikan gambar atau video dari komputer ke permukaan layar atau dinding dengan ukuran yang jauh lebih besar.",
    fakta: [
      "Perangkat output visual berukuran besar",
      "Kecerahan diukur dalam satuan lumen",
      "Tersedia teknologi LCD, DLP, dan laser",
    ],
    soal: [
      {
        q: "Proyektor termasuk perangkat...",
        opts: ["Input", "Proses", "Output", "Penyimpanan"],
        ans: 2,
      },
      {
        q: "Kecerahan proyektor diukur dalam satuan...",
        opts: ["Piksel", "Watt", "Lumen", "DPI"],
        ans: 2,
      },
      {
        q: "Proyektor paling sering digunakan untuk...",
        opts: [
          "Mencetak dokumen",
          "Presentasi dan menampilkan gambar berukuran besar",
          "Menyimpan data",
          "Merekam video",
        ],
        ans: 1,
      ...
      {
        q: "Teknologi proyektor yang menggunakan cermin mikro jutaan titik disebut...",
        opts: ["LCD", "DLP", "CRT", "OLED"],
        ans: 1,
      },
      {
        q: "Jarak proyektor ke layar mempengaruhi...",
        opts: [
          "Kecepatan komputer",
...
const STORAGE_HISTORY     = "game_history_level8";
const STORAGE_LEVEL8_DONE = "game_level8_ever_done";
const LEVEL = 8;
  ...
  return (
    <div className="side-panel">
      ...
      <div className="info-tip">
        ...
        <p>Susun puzzle 5×5 dengan benar untuk membuka pertanyaan tentang hardware ini!</p>
      </div>
    </div>
  );
}
...
export default function Level8() {
  ...
  const saveScore = useCallback((score, currentAttempt) => {
    ...
    const alreadyDone = getUserItem(STORAGE_LEVEL8_DONE, false);
    if (!alreadyDone) {
      setUserItem(STORAGE_LEVEL8_DONE, true);
      ...
      <div className="lv">
        ...
        <header className="lv-hdr">
          ...
          <div className="lv-hdr-right">
            ...
            <div className="lv-badge">LVL 8</div>
          </div>
        </header>
            ...
            <div className="lv-modal">
              ...
              <div style={{ marginBottom: 12, padding: "10px 16px", background: "rgba(120,0,255,.08)", border: "1px solid rgba(180,0,255,.25)" }}>
                <p style={{ fontSize: 12, color: "rgba(220,180,255,.85)", fontFamily: "Rajdhani", lineHeight: 1.6 }}>
                  ...
                  <strong style={{ color: "#e879f9", letterSpacing: 1 }}>LEVEL 8 — {hw.nama.toUpperCase()}</strong>
                </p>
              </div>
              ...
              <div className="lv-macts" style={{ marginTop: 8 }}>
                ...
                <button className="lv-btn lv-btn-g" onClick={() => navigate("/game/level/9")}>LANJUT →</button>
              </div>
            </div>
          </div>
        )}

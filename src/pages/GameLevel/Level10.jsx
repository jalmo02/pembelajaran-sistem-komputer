...
import imgAdministrator from "../../assets/puzzle/brainware/administrator.png";
import imgDataAnalyst   from "../../assets/puzzle/brainware/dataanalyst.png";
import imgOperator      from "../../assets/puzzle/brainware/operator.png";
import imgProgrammer    from "../../assets/puzzle/brainware/programmer.png";
import imgTeknisi       from "../../assets/puzzle/brainware/teknisi.png";

const BRAINWARE_LIST = [
  {
    img: imgAdministrator,
    nama: "Administrator",
    kategori: "Brainware",
    deskripsi:
      "Administrator adalah pengguna komputer yang bertugas mengelola, mengatur, dan memelihara sistem komputer atau jaringan agar berjalan dengan baik dan aman.",
    fakta: [
      "Memiliki hak akses tertinggi dalam sistem (super user)",
      "Bertanggung jawab atas keamanan dan stabilitas sistem",
      "Mengelola akun pengguna, izin, dan kebijakan sistem",
    ],
    soal: [
      {
        q: "Administrator sistem komputer memiliki hak akses yang disebut...",
        opts: ["Regular User", "Guest User", "Super User / Root", "Power User"],
        ans: 2,
      },
      {
        q: "Tugas utama seorang Administrator sistem adalah...",
        opts: [
      ...
      {
        q: "Administrator termasuk dalam kategori...",
        opts: ["Hardware", "Software", "Brainware", "Firmware"],
        ans: 2,
      },
      {
        q: "Salah satu tanggung jawab Administrator adalah mengelola...",
        opts: [
          "Desain grafis website",
          "Akun pengguna dan hak akses sistem",
      ...
      {
        q: "Ketika sebuah server mengalami gangguan, siapa yang pertama kali bertanggung jawab menanganinya?",
        opts: ["Programmer", "Desainer", "Administrator", "Operator"],
        ans: 2,
      },
      {
        q: "Brainware dalam sistem komputer merujuk pada...",
        opts: [
  ...
  },
  {
    ...
    kategori: "Brainware",
    deskripsi:
      "Data Analyst adalah profesional yang bertugas mengumpulkan, mengolah, dan menganalisis data untuk menghasilkan insight yang berguna dalam pengambilan keputusan bisnis.",
    fakta: [
      "Menggunakan tools seperti Excel, SQL, Python, dan Tableau",
      "Mengubah data mentah menjadi informasi yang bermakna",
      "Salah satu profesi paling dicari di era digital",
    ],
    soal: [
      {
        q: "Tugas utama seorang Data Analyst adalah...",
        opts: [
          "Membangun infrastruktur jaringan",
          "Mengolah dan menganalisis data untuk insight bisnis",
      ...
      {
        q: "Salah satu tools yang sering digunakan Data Analyst adalah...",
        opts: ["Photoshop", "CorelDRAW", "SQL dan Python", "Blender"],
        ans: 2,
      },
      {
        q: "Data Analyst mengubah data mentah menjadi...",
        opts: [
          "Program aplikasi",
          "Desain grafis",
          "Informasi dan insight yang bermakna",
          "Jaringan komputer",
        ],
        ans: 2,
      },
      {
        q: "Dalam proses kerja Data Analyst, langkah pertama yang dilakukan adalah...",
        opts: [
      ...
      {
        q: "Data Analyst termasuk dalam komponen sistem komputer yaitu...",
        opts: ["Hardware", "Software", "Brainware", "Network"],
        ans: 2,
      },
      {
        q: "Visualisasi data yang dibuat Data Analyst bertujuan untuk...",
        opts: [
          "Mempercantik tampilan website",
          "Membuat data lebih mudah dipahami oleh pengambil keputusan",
  ...
  },
  {
    ...
    kategori: "Brainware",
    deskripsi:
      "Operator komputer adalah pengguna yang bertugas menjalankan dan mengoperasikan perangkat komputer sesuai prosedur untuk menyelesaikan tugas-tugas tertentu sehari-hari.",
    fakta: [
      "Pengguna komputer pada tingkat paling dasar",
      "Menjalankan program dan aplikasi yang sudah tersedia",
      "Tidak perlu memahami cara kerja sistem secara mendalam",
    ],
    soal: [
      {
        q: "Operator komputer berada pada tingkatan brainware yang...",
        opts: ["Paling tinggi", "Paling dasar/rendah", "Menengah", "Spesialis"],
        ans: 1,
      },
      {
        q: "Tugas seorang Operator komputer adalah...",
        opts: [
          "Membuat sistem operasi baru",
          "Mengelola seluruh jaringan perusahaan",
          "Menjalankan program dan aplikasi untuk tugas sehari-hari",
          "Menganalisis dan memperbaiki bug program",
        ],
        ans: 2,
      },
      {
        q: "Contoh pekerjaan yang dilakukan Operator komputer adalah...",
        opts: [
      ...
      {
        q: "Operator komputer termasuk dalam komponen...",
        opts: ["Hardware", "Software", "Firmware", "Brainware"],
        ans: 3,
      },
      {
        q: "Perbedaan utama Operator dengan Programmer adalah...",
        opts: [
          "Operator membuat program, Programmer hanya menjalankannya",
          "Operator hanya menjalankan program yang sudah ada, Programmer membuat program",
          "Keduanya memiliki tugas yang sama",
          "Operator lebih ahli dari Programmer",
        ],
        ans: 1,
      },
      {
        q: "Seorang kasir yang menggunakan software kasir di toko termasuk dalam kategori...",
        opts: ["Programmer", "Administrator", "Teknisi", "Operator"],
        ans: 3,
      },
    ],
  },
  {
    ...
    kategori: "Brainware",
    deskripsi:
      "Programmer adalah profesional yang membuat, mengembangkan, dan memelihara program atau aplikasi komputer menggunakan bahasa pemrograman seperti Python, Java, C++, dan lainnya.",
    fakta: [
      "Menguasai satu atau lebih bahasa pemrograman",
      "Membuat kode (coding) untuk membangun aplikasi",
      "Terbagi menjadi Front-end, Back-end, dan Full-stack Developer",
    ],
    soal: [
      {
        q: "Tugas utama seorang Programmer adalah...",
        opts: [
          "Mengelola jaringan komputer",
          "Membuat dan mengembangkan program/aplikasi komputer",
          "Mengoperasikan komputer untuk tugas harian",
          "Memperbaiki kerusakan hardware",
        ],
        ans: 1,
      },
      {
        q: "Bahasa yang digunakan Programmer untuk membuat program disebut...",
        opts: ["Bahasa mesin saja", "Bahasa pemrograman", "Bahasa assembly saja", "Bahasa natural"],
        ans: 1,
      },
      {
        q: "Programmer yang fokus pada tampilan antarmuka pengguna disebut...",
        opts: ["Back-end Developer", "Database Administrator", "Front-end Developer", "System Analyst"],
        ans: 2,
      },
      {
        q: "Programmer yang menangani logika server dan database disebut...",
        opts: ["Front-end Developer", "Back-end Developer", "UI Designer", "Operator"],
        ans: 1,
      },
      {
        q: "Programmer termasuk dalam kategori komponen sistem komputer yaitu...",
        opts: ["Hardware", "Software", "Brainware", "Middleware"],
        ans: 2,
      },
      {
        q: "Proses menemukan dan memperbaiki kesalahan dalam kode program disebut...",
        opts: ["Compiling", "Rendering", "Debugging", "Deploying"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Brainware",
    deskripsi:
      "Teknisi komputer adalah profesional yang bertugas merakit, memperbaiki, merawat, dan memelihara perangkat keras (hardware) komputer agar dapat berfungsi dengan baik.",
    fakta: [
      "Ahli dalam perawatan dan perbaikan hardware komputer",
      "Melakukan instalasi sistem operasi dan software",
      "Mendiagnosis dan mengatasi masalah teknis komputer",
    ],
    soal: [
      {
        q: "Teknisi komputer bertanggung jawab atas...",
        opts: [
      ...
      {
        q: "Ketika monitor komputer tidak menyala, siapa yang tepat dipanggil?",
        opts: ["Programmer", "Data Analyst", "Administrator", "Teknisi"],
        ans: 3,
      },
      {
        q: "Teknisi komputer termasuk dalam kategori...",
        opts: ["Hardware", "Software", "Brainware", "Firmware"],
        ans: 2,
      },
      {
        q: "Salah satu tugas Teknisi komputer adalah...",
        opts: [
          "Menulis kode Python",
          "Menganalisis data penjualan",
          "Merakit dan menginstalasi komputer baru",
          "Membuat desain logo perusahaan",
        ],
        ans: 2,
      },
      {
        q: "Perbedaan utama Teknisi dengan Programmer adalah...",
        opts: [
          "Teknisi menangani hardware, Programmer menangani software",
          "Teknisi membuat program, Programmer memperbaiki hardware",
          "Keduanya memiliki tugas yang identik",
          "Teknisi lebih berperan di bidang desain",
        ],
        ans: 0,
      },
      {
        q: "Proses yang dilakukan Teknisi saat memasang komponen baru ke komputer disebut...",
        opts: ["Debugging", "Instalasi hardware", "Deployment", "Kompilasi"],
        ans: 1,
      },
    ],
  },
...
const STORAGE_HISTORY      = "game_history_level10";
const STORAGE_LEVEL10_DONE = "game_level10_ever_done";
const LEVEL = 10;
            ...
            return (
              <div key={i} className="history-item">
                <div className="history-item-top">
                  ...
                  <span className="history-hw" title={h.bw}>
                    {h.bw && h.bw.length > 14 ? h.bw.slice(0, 13) + "…" : h.bw}
                  </span>
                  {h.timeout ? (
  ...
  return (
    <div className="side-panel">
      <div className="panel-header">
        ...
        <span>INFO BRAINWARE</span>
      </div>
      <div className="info-hw-hero">
        <div className="info-hw-img-wrap">
          <img src={bw.img} alt={bw.nama} className="info-hw-img" />
          <div className="info-hw-img-glow" />
        </div>
        <p className="info-hw-name">{bw.nama}</p>
        <span className="info-kategori-badge">{bw.kategori.toUpperCase()}</span>
      </div>
      <div className="info-section">
        <p className="info-section-label">DESKRIPSI</p>
        <p className="info-desc">{bw.deskripsi}</p>
      </div>
      <div className="info-section">
      ...
      <div className="info-tip">
        ...
        <p>Susun puzzle 6×6 dengan benar untuk membuka pertanyaan tentang brainware ini!</p>
      </div>
    </div>
  );
}
...
export default function Level10() {
  ...
  const [bw] = useState(
    () => BRAINWARE_LIST[Math.floor(Math.random() * BRAINWARE_LIST.length)],
  );
  ...
  const makeTimeoutEntry = useCallback(() => {
    const now = new Date();
    return {
      bw: bw.nama, score: 0, timeLeft: "00:00",
  ...
  const triggerSolved = useCallback(() => {
    setSolved(true);
    setTimeout(() => {
      const shuffled = shuffle(bw.soal);
  ...
  const saveScore = useCallback((score, currentAttempt) => {
    ...
    const alreadyDone = getUserItem(STORAGE_LEVEL10_DONE, false);
    if (!alreadyDone) {
      setUserItem(STORAGE_LEVEL10_DONE, true);
    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes crownGlow     { 0%,100%{filter:drop-shadow(0 0 6px #FBBF24)} 50%{filter:drop-shadow(0 0 18px #FBBF24) drop-shadow(0 0 32px #f59e0b)} }
        ...
        .info-hw-img { width:80px; height:80px; object-fit:contain; position:relative; z-index:1; filter:drop-shadow(0 0 12px rgba(180,0,255,.4)); border-radius:50%; }
        ...
        .lv-final-badge { display:inline-flex; align-items:center; gap:8px; padding:6px 16px; margin-bottom:12px; background:linear-gradient(135deg,rgba(251,191,36,.12),rgba(245,158,11,.06)); border:1px solid rgba(251,191,36,.4); }
        .lv-final-badge span { font-family:'Rajdhani'; font-size:11px; font-weight:700; color:#FBBF24; letter-spacing:2px; }
        .lv-crown { animation:crownGlow 2s ease-in-out infinite; }
      `}</style>
      ...
      <div className="lv">
        ...
        <header className="lv-hdr">
          ...
          <div className="lv-htitle">
            <h1>PUZZLE GAME</h1>
            <p>{bw.nama.toUpperCase()}</p>
          </div>
          <div className="lv-hdr-right">
            <TimerDisplay seconds={timeLeft} />
            <div className="lv-badge">LVL 10</div>
          </div>
        </header>
                ...
                <div className="lv-board-wrap">
                      ...
                      >
                        {pi !== null ? (
                          <div className="lv-placed" draggable onDragStart={(e) => onDragStartBoard(e, si)}>
                            <PuzzlePiece imgSrc={bw.img} pieceIdx={pi} size={PIECE} grid={GRID} />
                          </div>
                        ) : (
                  ...
                  <div className="lv-preview-row" style={{ width: BOARD_TOTAL + GAP * 2 }}>
                    <button className="lv-prev-btn" onClick={() => setShowPreview(true)}>
                      <span>PREVIEW:</span>
                      <div className="lv-prev-img"><img src={bw.img} alt={bw.nama} /></div>
                    </button>
                        ...
                        >
                          {pi !== undefined ? (
                            <div className="lv-tray-piece" draggable onDragStart={(e) => onDragStartTray(e, pi)}>
                              ...
                              <PuzzlePiece imgSrc={bw.img} pieceIdx={pi} size={TRAY_PIECE} grid={GRID} />
                            </div>
                          ) : (
              ...
              <div style={{ width: "100%", maxWidth: 580, padding: "0 16px" }}>
                ...
                <div className="lv-qcard">
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                    <div style={{ width: 38, height: 38, overflow: "hidden", border: "1px solid rgba(180,0,255,.3)", borderRadius: "50%", flexShrink: 0 }}>
                      <img src={bw.img} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    </div>
                    <p style={{ fontSize: 10, color: "rgba(180,0,255,.55)", letterSpacing: 2, fontFamily: "Rajdhani" }}>
                      {bw.nama.toUpperCase()} — {bw.kategori.toUpperCase()}
                    </p>
                  </div>
          ...
          <div className="lv-overlay" onClick={() => setShowPreview(false)}>
            <div className="lv-modal lv-preview-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <p style={{ fontSize: 9, letterSpacing: 4, color: "rgba(180,0,255,.5)", marginBottom: 14, fontFamily: "Rajdhani" }}>
                PREVIEW — {bw.nama.toUpperCase()}
              </p>
              <img src={bw.img} alt={bw.nama} />
          ...
          <div className="lv-overlay">
            <div className="lv-modal">
              ...
              <p className="lv-mdesc">
                ...
                Puzzle 6×6 Level Final memang sangat menantang,<br />
                tapi kamu pasti bisa! Coba lagi dalam <strong style={{ color: "rgba(200,150,255,.9)" }}>7 menit</strong>.
              </p>
              <div className="lv-macts">
          ...
          <div className="lv-overlay">
            <div className="lv-modal">
              ...
              <div style={{ marginBottom: 8 }}>
                <svg className="lv-crown" width="40" height="40" viewBox="0 0 24 24" fill="#FBBF24" stroke="#f59e0b" strokeWidth="1">
                  <path d="M2 20h20M4 20L2 8l5 4 5-7 5 7 5-4-2 12H4z"/>
                </svg>
              </div>
              ...
              <div style={{ display: "inline-block", padding: "6px 20px", marginBottom: 10, background: `${sc}14`, border: `1px solid ${sc}40` }}>
                <p style={{ fontSize: 12, fontWeight: 900, color: sc, letterSpacing: 3, fontFamily: "Orbitron" }}>{sl}</p>
              </div>

              <div className="lv-final-badge">
                <svg className="lv-crown" width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24" stroke="#f59e0b" strokeWidth="1">
                  <path d="M2 20h20M4 20L2 8l5 4 5-7 5 7 5-4-2 12H4z"/>
                </svg>
                <span>LEVEL FINAL — TAMAT!</span>
              </div>

              <div className="lv-difficulty-badge" style={{ marginBottom: 12 }}>
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="2">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                </svg>
                <span>PUZZLE 6×6 — LEVEL GRANDMASTER</span>
              </div>
              ...
              <div style={{ marginBottom: 12, padding: "10px 16px", background: "rgba(120,0,255,.08)", border: "1px solid rgba(180,0,255,.25)" }}>
                <p style={{ fontSize: 12, color: "rgba(220,180,255,.85)", fontFamily: "Rajdhani", lineHeight: 1.6 }}>
                  ...
                  <strong style={{ color: "#e879f9", letterSpacing: 1 }}>LEVEL 10 — {bw.nama.toUpperCase()}</strong>
                </p>
              </div>

              {isFirstEverDone && (
                <div style={{ marginBottom: 12, padding: "10px 16px", background: "linear-gradient(135deg,rgba(251,191,36,.1),rgba(245,158,11,.05))", border: "1px solid rgba(251,191,36,.4)", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24" stroke="#f59e0b" strokeWidth="1">
                    <path d="M2 20h20M4 20L2 8l5 4 5-7 5 7 5-4-2 12H4z"/>
                  </svg>
                  <p style={{ fontSize: 11, color: "#FBBF24", letterSpacing: 2, fontFamily: "Rajdhani", fontWeight: 700 }}>

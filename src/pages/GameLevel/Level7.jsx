...
const SOFTWARE_LIST = [
  {
    ...
    soal: [
      ...
      {
        q: "Android berbasis kernel dari sistem operasi...",
        opts: ["Windows", "macOS", "Linux", "Unix"],
        ans: 2,
      },
      {
        q: "Android dirancang utamanya untuk perangkat...",
        opts: ["Komputer desktop", "Laptop", "Server", "Smartphone dan tablet"],
        ans: 3,
      },
      {
        q: "Android termasuk jenis software...",
        opts: ["Aplikasi", "Sistem operasi", "Antivirus", "Browser"],
        ans: 1,
      },
      {
  ...
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Google Chrome adalah peramban web (web browser) yang dikembangkan oleh Google, dikenal karena kecepatan, keamanan, dan integrasi dengan layanan Google.",
    fakta: [
    ...
    soal: [
      {
        q: "Google Chrome adalah perangkat lunak jenis...",
        opts: ["Sistem operasi", "Antivirus", "Web browser", "Pengolah kata"],
        ans: 2,
      },
      {
        q: "Google Chrome dikembangkan oleh...",
        opts: ["Microsoft", "Mozilla", "Apple", "Google"],
        ans: 3,
      },
      {
        q: "Fitur tambahan pada Chrome dapat dipasang melalui...",
        opts: ["App Store", "Play Store", "Chrome Web Store", "Microsoft Store"],
        ans: 2,
      },
      {
        q: "Fungsi utama web browser seperti Chrome adalah...",
        opts: [
      ...
      {
        q: "Chrome pertama kali diluncurkan pada tahun...",
  ...
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "CorelDRAW adalah perangkat lunak desain grafis berbasis vektor yang digunakan untuk membuat ilustrasi, logo, tata letak halaman, dan berbagai karya desain profesional.",
    fakta: [
      "Software desain grafis vektor populer",
      "Dikembangkan oleh Corel Corporation",
      "File format utama: .CDR",
    ],
    soal: [
      {
      ...
      {
        q: "Format file utama yang dihasilkan CorelDRAW adalah...",
        opts: [".PSD", ".AI", ".CDR", ".PNG"],
        ans: 2,
      },
      {
        q: "CorelDRAW menggunakan teknologi grafis berbasis...",
        opts: ["Raster/bitmap", "Vektor", "3D modeling", "Audio"],
        ans: 1,
      },
      {
        q: "Salah satu kegunaan CorelDRAW adalah membuat...",
        opts: [
          "Database perusahaan",
          "Spreadsheet keuangan",
          "Logo dan ilustrasi profesional",
          "Sistem operasi",
        ],
        ans: 2,
      },
  ...
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Microsoft Excel adalah perangkat lunak pengolah angka (spreadsheet) yang digunakan untuk mengolah data, membuat tabel, grafik, dan melakukan perhitungan matematis.",
    fakta: [
      "Termasuk paket Microsoft Office",
      "Menggunakan sistem sel berbaris dan berkolom",
      "Mendukung rumus dan fungsi matematika",
    ],
    soal: [
      {
        q: "Microsoft Excel adalah software pengolah...",
        opts: ["Kata/teks", "Angka/spreadsheet", "Gambar/foto", "Presentasi"],
        ans: 1,
      },
      {
        q: "Excel merupakan bagian dari paket...",
        opts: ["Adobe Creative Suite", "Google Workspace", "Microsoft Office", "LibreOffice saja"],
        ans: 2,
      },
      {
        q: "Pertemuan antara baris dan kolom di Excel disebut...",
        opts: ["Tabel", "Kolom", "Sel (Cell)", "Lembar kerja"],
        ans: 2,
      },
      {
        q: "Untuk menghitung penjumlahan otomatis di Excel digunakan fungsi...",
        opts: ["=AVERAGE()", "=COUNT()", "=SUM()", "=MAX()"],
        ans: 2,
      },
      {
        q: "Format file default Microsoft Excel adalah...",
        opts: [".DOC", ".PPT", ".XLSX", ".PDF"],
        ans: 2,
      },
    ],
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Linux adalah sistem operasi open source berbasis Unix yang dikembangkan oleh Linus Torvalds, banyak digunakan di server, komputer desktop, dan perangkat embedded.",
    fakta: [
      "Sistem operasi open source dan gratis",
      "Dikembangkan pertama oleh Linus Torvalds (1991)",
      "Tersedia dalam berbagai distro: Ubuntu, Debian, Fedora",
    ],
    soal: [
      {
        q: "Linux pertama kali dikembangkan oleh...",
        opts: ["Bill Gates", "Steve Jobs", "Linus Torvalds", "Mark Zuckerberg"],
        ans: 2,
      },
      {
        q: "Linux adalah sistem operasi yang bersifat...",
        opts: ["Berbayar dan tertutup", "Open source dan gratis", "Hanya untuk perusahaan", "Khusus untuk Mac"],
        ans: 1,
      },
      {
      ...
      {
        q: "Berikut yang BUKAN merupakan distro Linux adalah...",
        opts: ["Ubuntu", "Debian", "Fedora", "Windows"],
        ans: 3,
      },
      {
        q: "Linux banyak digunakan sebagai sistem operasi...",
        opts: [
          "Hanya untuk gaming",
          "Server dan komputer desktop",
          "Khusus smartphone saja",
          "Hanya untuk desain grafis",
        ],
        ans: 1,
      },
    ],
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Adobe Photoshop adalah perangkat lunak pengolah gambar berbasis raster yang digunakan untuk mengedit foto, membuat desain grafis, dan manipulasi gambar secara profesional.",
    fakta: [
      "Software pengolah gambar berbasis raster/bitmap",
      "Dikembangkan oleh Adobe Inc.",
      "Format file utama: .PSD (Photoshop Document)",
    ],
    soal: [
      {
        ...
        opts: [
          "Membuat presentasi",
          "Mengolah angka",
          "Mengedit dan memanipulasi gambar/foto",
          "Browsing internet",
        ],
        ans: 2,
      },
      {
        q: "Photoshop dikembangkan oleh perusahaan...",
        opts: ["Microsoft", "Adobe Inc.", "Corel", "Apple"],
        ans: 1,
      },
      {
        q: "Photoshop menggunakan teknologi grafis berbasis...",
        opts: ["Vektor", "Raster/bitmap", "3D modeling", "Audio"],
        ans: 1,
      },
      {
        q: "Format file asli Photoshop yang menyimpan semua layer adalah...",
        opts: [".CDR", ".AI", ".PSD", ".SVG"],
        ans: 2,
      },
      {
        q: "Perbedaan utama Photoshop dengan CorelDRAW adalah...",
        opts: [
          "Photoshop berbasis vektor, CorelDRAW berbasis raster",
          "Photoshop berbasis raster, CorelDRAW berbasis vektor",
          "Keduanya sama-sama berbasis vektor",
          "Keduanya sama-sama berbasis raster",
        ],
        ans: 1,
      },
    ],
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Microsoft PowerPoint adalah perangkat lunak presentasi yang digunakan untuk membuat slide presentasi dengan teks, gambar, animasi, dan multimedia.",
    fakta: [
      "Termasuk paket Microsoft Office",
    ...
    soal: [
      ...
      {
        q: "PowerPoint merupakan bagian dari...",
        opts: ["Adobe Suite", "Google Workspace", "Microsoft Office", "LibreOffice saja"],
        ans: 2,
      },
      {
        q: "Tampilan utama yang digunakan untuk presentasi di PowerPoint disebut...",
        opts: ["Lembar kerja", "Sel", "Slide", "Dokumen"],
        ans: 2,
      },
      {
      ...
      {
        q: "Fitur animasi pada PowerPoint digunakan untuk...",
        opts: [
          "Menghitung data otomatis",
          "Membuat teks bergerak dan transisi antar slide",
          "Menyimpan file ke cloud",
          "Mengedit foto",
        ],
        ans: 1,
  ...
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Windows adalah sistem operasi yang dikembangkan oleh Microsoft, menjadi sistem operasi paling banyak digunakan di komputer personal (PC) di seluruh dunia.",
    fakta: [
      "Sistem operasi PC paling populer di dunia",
      "Dikembangkan oleh Microsoft Corporation",
      "Versi terbaru: Windows 11 (2021)",
    ],
    soal: [
      {
        q: "Sistem operasi Windows dikembangkan oleh...",
        opts: ["Google", "Apple", "Microsoft", "IBM"],
        ans: 2,
      },
      {
        q: "Windows termasuk jenis software...",
        opts: ["Aplikasi", "Sistem operasi", "Antivirus", "Browser"],
        ans: 1,
      },
      {
        q: "Versi Windows pertama yang populer di masyarakat luas adalah...",
        opts: ["Windows 1.0", "Windows 3.1", "Windows 95", "Windows XP"],
        ans: 2,
      },
      {
      ...
      {
        q: "Windows digunakan sebagai sistem operasi pada perangkat...",
        opts: [
          "Hanya smartphone",
          "Hanya server",
          "Komputer personal (PC) dan laptop",
          "Hanya smartwatch",
        ],
        ans: 2,
      },
  ...
  },
  {
    ...
    kategori: "Software",
    deskripsi:
      "Microsoft Word adalah perangkat lunak pengolah kata yang digunakan untuk membuat, mengedit, dan memformat dokumen teks seperti surat, laporan, dan artikel.",
    fakta: [
      "Termasuk paket Microsoft Office",
    ...
    soal: [
      {
        q: "Microsoft Word adalah software pengolah...",
        opts: ["Angka", "Kata/teks", "Gambar", "Presentasi"],
        ans: 1,
      },
      {
        q: "Word merupakan bagian dari paket...",
        opts: ["Adobe Creative Suite", "Google Workspace", "Microsoft Office", "LibreOffice saja"],
        ans: 2,
      },
      {
      ...
      {
        q: "Fitur untuk mengecek ejaan otomatis di Word disebut...",
        opts: ["AutoFill", "Spell Check", "AutoSum", "Mail Merge"],
        ans: 1,
      },
      {
        q: "Salah satu dokumen yang umum dibuat menggunakan Word adalah...",
        opts: [
          "Tabel perhitungan keuangan",
          "Slide presentasi",
          "Surat dan laporan",
          "Desain logo",
        ],
...
const STORAGE_HISTORY     = "game_history_level7";
const STORAGE_LEVEL7_DONE = "game_level7_ever_done";
const LEVEL = 7;
...
// ── DIRS untuk keping puzzle (generated, dijamin nyambung tanpa bolong) ──────
// [top, right, bottom, left]  0=flat  1=tab keluar  -1=tab masuk
// Aturan: left[piece kanan] = -right[piece kiri], top[piece bawah] = -bottom[piece atas]
// Dengan generate otomatis, setiap pasangan tab yang bersentuhan PASTI berlawanan tanda.
function generateDirs(grid) {
  const right = [];  // right[r][c] untuk c = 0..grid-2
  const bottom = []; // bottom[r][c] untuk r = 0..grid-2
...
function useResponsiveSizes() {
  function calc() {
    ...
    if (isMobile) {
      const availW = vw - 32;
      const availH = vh - 160;
      const maxByW = Math.floor(availW / 5) - GAP * 2;
      const maxByH = Math.floor(availH * 0.45) - 40;
      PIECE = Math.max(28, Math.min(52, maxByW, maxByH));
      TRAY_PIECE = Math.round(PIECE * 0.72);
    } else if (isTablet) {
      const availW = vw - 48;
      const availH = vh - 120;
      const boardMaxW = Math.floor(availW * 0.52 / 5) - GAP * 2;
      const maxByH    = Math.floor(availH) - 80;
      PIECE = Math.max(36, Math.min(68, boardMaxW, maxByH));
      TRAY_PIECE = Math.round(PIECE * 0.72);
    } else {
      const centerW = vw - 80;
      const centerH = vh - 60 - 48;
      const byWidth  = Math.floor((centerW - 104) / 8.8);
      const byHeight = Math.floor(centerH / 5) - 12;
      PIECE = Math.max(42, Math.min(90, byWidth, byHeight));
...
// ── PuzzlePiece ───────────────────────────────────────────────────────────────
function PuzzlePiece({ imgSrc, pieceIdx, size, grid = 5 }) {
  ...
  return (
    <div className="side-panel">
      ...
      <div className="info-tip">
        ...
        <p>Susun puzzle 5×5 dengan benar untuk membuka pertanyaan tentang software ini!</p>
      </div>
    </div>
  );
}
...
export default function Level7() {
  ...
  const saveScore = useCallback((score, currentAttempt) => {
    ...
    const alreadyDone = getUserItem(STORAGE_LEVEL7_DONE, false);
    if (!alreadyDone) {
      setUserItem(STORAGE_LEVEL7_DONE, true);
      ...
      <div className="lv">
        ...
        <header className="lv-hdr">
          ...
          <div className="lv-hdr-right">
            ...
            <div className="lv-badge">LVL 7</div>
          </div>
        </header>
            ...
            {phase === PHASE.PUZZLE && (
              <div className="lv-main">
                ...
                <div className="lv-board-wrap">
                  <p className="lv-board-label">PAPAN PUZZLE 5×5</p>
                  <div
                    className="lv-board"
                    style={{
                ...
                <div className="lv-tray-wrap">
                  <p className="lv-tray-label">KEPING PUZZLE (25)</p>
                  <div
                    className={`lv-tray${dragOver === "tray" ? " over" : ""}`}
                    style={{
                      gridTemplateColumns: `repeat(${TRAY_COLS}, ${TRAY_PIECE + 10}px)`,
                      gridTemplateRows:    `repeat(${TRAY_ROWS}, ${TRAY_PIECE + 10}px)`,
                    }}
                    ...
                    {[...Array(TOTAL).keys()].map((slotIdx) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ width: TRAY_PIECE + 10, height: TRAY_PIECE + 10 }}
                        >
                          {pi !== undefined ? (
          ...
          <div className="lv-overlay">
            <div className="lv-modal">
              ...
              <p className="lv-mdesc">
                ...
                Puzzle 5×5 memang lebih menantang,<br />
                tapi kamu pasti bisa! Coba lagi dalam <strong style={{ color: "rgba(200,150,255,.9)" }}>5 menit</strong>.
              </p>
              <div className="lv-macts">
          ...
          <div className="lv-overlay">
            <div className="lv-modal">
              ...
              <div className="lv-difficulty-badge">
                ...
                <span>PUZZLE 5×5 — LEVEL EXPERT</span>
              </div>
              <div style={{ marginBottom: 12, padding: "10px 16px", background: "rgba(120,0,255,.08)", border: "1px solid rgba(180,0,255,.25)" }}>
                <p style={{ fontSize: 12, color: "rgba(220,180,255,.85)", fontFamily: "Rajdhani", lineHeight: 1.6 }}>
                  ...
                  <strong style={{ color: "#e879f9", letterSpacing: 1 }}>LEVEL 7 — {hw.nama.toUpperCase()}</strong>
                </p>
              </div>
              ...
              <div className="lv-macts" style={{ marginTop: 8 }}>
                ...
                <button className="lv-btn lv-btn-g" onClick={() => navigate("/game/level/8")}>LANJUT →</button>
              </div>
            </div>
          </div>
        )}
